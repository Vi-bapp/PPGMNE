...
set output 'TRIxREC-delaunay.png'
...
set title "Delaunay mesh L² convergence: triangle vs. rectangle"
...
plot 'TRIxREC.dat' using 1:2 with linespoints pt 7 ps 1.5 lc rgb "blue" title "(TRI)", \
     '' using 1:3 with linespoints pt 5 ps 1.5 lc rgb "green" title "(REC)", \
