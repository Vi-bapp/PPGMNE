...
% título
\title{Análise de vibração livre em estruturas no estado plano de tensões através do método dos elementos virtuais}
...
\descr{Dissertação apresentada como requisito à obtenção do grau de Mestre em Métodos Numéricos no Programa de Pós-Graduação em Métodos Numéricos em Engenharia, Setor de Ciências Exatas, da Universidade Federal do Paraná}
